...
public class RobotContainer {
    ...
    /**Commands */
    private final SetElevatorPosition elevatorCoralLv4 = new SetElevatorPosition(elevatorSubsystem, 80);
    private final SetElevatorPosition elevatorCoralLv3 = new SetElevatorPosition(elevatorSubsystem, 70);
    private final SetElevatorPosition elevatorCoralLv2 = new SetElevatorPosition(elevatorSubsystem, 60);
    private final SetElevatorPosition elevatorCoralLv1 = new SetElevatorPosition(elevatorSubsystem, 50);
    ...
    private void configureBindings() {
        ...
        opController.x().onTrue(elevatorHome);
    }
