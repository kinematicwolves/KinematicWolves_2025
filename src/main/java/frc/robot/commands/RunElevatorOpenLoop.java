...
public class RunElevatorOpenLoop extends Command {
   ...
   */
  public RunElevatorOpenLoop(Elevator elevatorSub, XboxController xboxController) {
  ...
  @Override
  public void execute() {
    this.elevatorSubsystem.setElevatorSpeed(-xboxController.getLeftY());
  }

  // Called once the command ends or is interrupted.
  @Override
  public void end(boolean interrupted) {
    this.elevatorSubsystem.setElevatorSpeed(0);
  }
